  ...
  return (
    <div className='flex bg-gradient-to-r from-[var(--wrapperColor)] to-[var(--bgColor)] flex-col text-[var(--textColor)] z-50 fixed inset-0 justify-center items-center'>
       <div className='flex flex-col items-center gap-4 justify-center'>
        <div className='px-0.5 py-8 bg-white/90 flex items-center justify-center rounded-[40px] border-1 border-[var(--borderColor)]'>
          <Image src="/images/ig.png" alt="logo" className='w-[80px] h-[65px]'  width={80} height={80} />
          <Image src="/images/m.png" alt="logo" className='w-[70px]  h-[70px] animate-bounce mt-3'  width={80} height={80} />
        </div>
