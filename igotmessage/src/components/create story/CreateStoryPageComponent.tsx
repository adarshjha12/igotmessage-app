...
function CreateStoryPageComponent() {
  ...
  return (
    <div className='w-full py-5 overflow-hidden min-h-screen flex flex-col items-center justify-start gap-2.5 bg-[var(--bgColor)] backdrop-blur-md text-[var(--textColor)] '>
      <div className='w-full sm:w-[50%] px-2 py-2 h-full flex flex-col items-center justify-start gap-2.5 '>
        ...
        >
          ...
          onClick={() => {
            ...
            type="button"
            className={` cursor-pointer justify-center sm:w-fit rounded-2xl px-2 py-1 flex items-center gap-3 active:bg-[var(--wrapperColor)] active:scale-95 ${selectWriteClicked ? 'bg-[var(--textColor)] text-[var(--bgColor)]' : ''}`}
          >
            <div className='flex relative justify-center items-center'>
              <div className='flex flex-col items-center justify-center gap-1'>
      ...
      {selectMusicClicked && <div className=' overflow-y-auto w-full px-2 down-slide h-[80%] sm:w-fit  py-2 top-35 z-50 fixed flex pb-16 items-start justify-center '>
        <MusicComponent/>
      </div>}
