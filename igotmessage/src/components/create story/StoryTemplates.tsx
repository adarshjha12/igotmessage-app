...
function StoryTemplates() {
  ...
  const [loadedImagesCity, setLoadedImagesCity] = React.useState<{[key: number]: boolean}>({})
  const [loadedImagesPets, setLoadedImagesPets] = React.useState<{[key: number]: boolean}>({})
  const [loadedImagesNature, setLoadedImagesNature] = React.useState<{[key: number]: boolean}>({})
  const [loadedImagesPattern, setLoadedImagesPattern] = React.useState<{[key: number]: boolean}>({})
  const [loadedImagesGrayscale, setLoadedImagesGrayscale] = React.useState<{[key: number]: boolean}>({})
      ...
      <div className='w-full flex px-2 gap-3 flex-col justify-center items-center'>
        ...
        <div className='w-full flex gap-0 flex-col justify-center items-center'>
          <div className='w-full flex px-3 flex-col items-start flex-wrap justify-center'>
            ...
            <div className={`flex gap-6 ${cityImagesShow ? 'overflow-auto down-slide h-full' : 'overflow-hidden h-[150px]'} flex-wrap justify-start items-center`}>
              {cityImages.map((image, index) => (
                <div key={index} className='flex w-[150px] h-[150px] justify-center text-center items-center relative'>
                  ...
                  style={loadedImagesCity[index] ? {opacity: 1} : {opacity: 0}}
          ...
          <div className='w-full flex px-3 flex-col items-start flex-wrap justify-center'>
            ...
            <div className={`flex gap-6 ${petImagesShow ? 'down-slide overflow-auto h-full' : 'overflow-hidden h-[150px]'} flex-wrap justify-start items-center`}>
              {petImages.map((image, index) => (
                <div key={index} className='flex w-[150px] h-[150px] justify-center text-center items-center relative'>
                  <Image
                  onLoad={() => handleImageLoad(index, 'pets')}
                  style={loadedImagesPets[index] ? {opacity: 1} : {opacity: 0}}
                  className=' object-cover rounded-md'
                  src={image.url} priority sizes='150px' fill alt='' />
          ...
          <div className='w-full flex px-3 flex-col items-start flex-wrap justify-center'>
            ...
            <div className={`flex gap-6 ${natureImagesShow ? 'down-slide overflow-auto h-full' : 'overflow-hidden h-[150px]'} flex-wrap justify-start items-center`}>
              {natureImages.map((image, index) => (
                <div key={index} className='flex w-[150px] h-[150px] justify-center text-center items-center relative'>
                 <Image
                  onLoad={() => handleImageLoad(index, 'nature')}
                  style={loadedImagesNature[index] ? {opacity: 1} : {opacity: 0}}
                  className=' object-cover rounded-md'
                  src={image.url} priority sizes='150px' fill alt='' />
          ...
          <div className='w-full flex px-3 flex-col items-start flex-wrap justify-center'>
            ...
            <div className={`flex gap-6 ${patternImagesShow ? 'down-slide overflow-auto h-full' : 'overflow-hidden h-[150px]'} flex-wrap justify-start items-center`}>
              {patternImages.map((image, index) => (
                <div key={index} className='flex w-[150px] h-[150px] justify-center text-center items-center relative'>
                  <Image
                  onLoad={() => handleImageLoad(index, 'pattern')}
                  style={loadedImagesPattern[index] ? {opacity: 1} : {opacity: 0}}
                  className=' object-cover rounded-md'
                  src={image.url} priority sizes='150px' fill alt='' />
          ...
          <div className='w-full flex px-3 flex-col items-start flex-wrap justify-center'>
            ...
            <div className={`flex gap-6 ${grayImagesShow ? 'down-slide overflow-auto h-full' : 'overflow-hidden h-[150px]'} flex-wrap justify-start items-center`}>
              {grayImages.map((image, index) => (
                <div key={index} className='flex w-[150px] h-[150px] justify-center text-center items-center relative'>
                  <Image
                  onLoad={() => handleImageLoad(index, 'grayscale')}
                  style={loadedImagesGrayscale[index] ? {opacity: 1} : {opacity: 0}}
                  className=' object-cover rounded-md'
                  src={image.url} priority sizes='150px' fill alt='' />
