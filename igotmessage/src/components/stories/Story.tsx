  ...
  return (
    <div className="w-full py-4 px-0 h-fit z-0 flex overflow-x-auto whitespace-nowrap gap-2 scroll-smooth hide-scrollbar">
      ...
      <div className="flex flex-col items-center justify-center gap-2">
        <Link
          href="/create-story"
          className="relative w-[75px] h-[75px] flex items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-indigo-800 shadow-md hover:scale-105 transition-transform duration-300 ease-out group"
        >
